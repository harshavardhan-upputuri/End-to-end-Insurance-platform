    ...
    <div className='relative flex flex-col'>  
      ...
      <section className='grid grid-cols-4 gap-4 m-20'>
        {features.map((item,id)=>(
          <div className='w-[200px] h-[250px] flex flex-col gap-1 items-center shadow-custom border border-[#8d8d8d]  m-6    rounded-md  cursor-pointer shadow hover:shadow-2xl'>
