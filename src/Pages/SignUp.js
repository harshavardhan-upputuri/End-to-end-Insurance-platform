...
const SignUp = () => {
  ...
  return (
    <div className='flex items-center  rounded-xl h-[700px]  shadow-xl '>
      {/* bg-[#EAF4F4] */}
      ...
      <div className=' relative -ml-[136px] h-[650px] w-[500px] rounded-r-2xl bg-blue-300'>
        ...
        <h2 htmlFor="first_name" className="absolute ml-[90px] top-[130px] block  font-bold mb-4 text-[22px]  text-gray-900 dark:text-white">Sign Up</h2>
        <form className='absolute left-1/2 transform -translate-x-1/2 flex flex-col   top-[200px]'>
