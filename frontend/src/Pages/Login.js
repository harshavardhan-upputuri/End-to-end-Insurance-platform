            ...
            <div className=' relative m-4 -ml-[20px] h-[800px] w-[600px] rounded-r-2xl bg-blue-300'>
                ...
                <form className='absolute left-1/2 transform -translate-x-1/2 flex flex-col   top-[100px]'>
                    ...
                    <div className='ml-[30px]  m-10'>
                        <button type="button" className="w-[400px] text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Login</button>
                    ...
                    <div className='ml-[30px]  '>
                        <p >Don't have an account? <span onClick={()=>navigate("/signup")} className='ml-10 text-blue-900 cursor-pointer'>Create an Account</span></p>
                    </div>
                </form>
            </div>
