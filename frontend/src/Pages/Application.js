    ...
    return (
        <div className={`m-4 shadow-2xl  h-full   `}>
            ...
            <div className='ml-[20px]'>
                <h1 className='font-bold text-[24px] m-6 ml-[720px]'>Application form</h1>
                ...
                <form className='m-4'>
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="ml-[150px]"><FileUpload name={"Pan card"}/></div>
                    ...
                    {/* Submit */}
                    <div className="ml-[500px] flex items-center ">
                        ...
                        <label htmlFor="remember" className="ms-2   mb-4 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a>.</label>
                       <button type="submit"  className="ml-10 bg-gradient-to-r  mb-4  from-orange-400 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white rounded-2xl px-5 py-1 text-[20px]">Submit</button>
                    </div>
