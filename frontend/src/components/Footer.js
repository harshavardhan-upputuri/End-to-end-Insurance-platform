...
const Footer = () => {
  return (
    <div className='bg-blue-950 h-[350px] flex flex-col text-[#c7cfdd] '>
        <div className='flex text-[#c7cfdd] justify-between mt-14'>
            ...
            <div className="flex flex-col mx-auto">
                ...
                <div className="flex gap-2 mb-4">
                    <img className='mt-2 w-[120px]'  src={assets.app} alt=""/>
                    <img className='mt-2 w-[120px]' src={assets.play} alt=""/>                    
                </div>
